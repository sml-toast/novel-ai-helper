...
> **本文是手工回归清单**（B/F/T 编号，按表人工执行）。
> 自动化测试体系（Playwright 契约层 + 页面烟雾层，28 条用例）的说明见
> [`test-automation.md`](./test-automation.md)——F077 之后自动化已承接「防回归」职责，
> 本文重点覆盖自动化难做的组合交互与真实 AI provider 验收。
...
| T071 | 点击图谱类型按钮 | 切换图谱视图（all/character/knowledge/timeline/world） | ⏳ Pending |
| T072 | 点击辅助标签 | 切换 AI 辅助侧栏标签页 | ⏳ Pending |
| T073 | 点击关闭面板 | 关闭所有打开的面板 | ⏳ Pending |
| T069 | 点击 B007 知识库 | 打开知识库面板（F068），显示知识图谱、角色关系、情节线索、世界设定 | ⏳ Pending |
| T070 | 点击 B008 发布计划 | 打开发布计划面板（F069），显示发布队列、定时发布、归档管理 | ⏳ Pending |
...
| 日期 | 测试人员 | 测试数量 | 通过率 | 备注 |
|------|----------|----------|--------|------|
| 2026-07-13 | Codex | 26 | 100% | 全部回归测试通过，新增交互控制器测试用例 |
