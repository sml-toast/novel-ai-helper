...
| **T011 多项目支持（M5 首项）** | ✅ | 2026-09-06 | F079：项目上下文解析器 + 存在性校验 + 前端切换器 + 新建项目向导 + 导入后自动切换；测试扩至 33 条全绿 | 本轮交付 |
| M5 · 长篇结构化 | 🔄 进行中 | 2026-09-06 起 | T011 多项目 ✅；剩余 T012–T018：FTS5 检索 / 提及反链 / 按需召回 / 流式 / 调度器等（≈17.5 人天） | roadmap §三 |
